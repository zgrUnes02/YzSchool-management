...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">{{ trans('students_trans.edit_fee') }}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="{{route('home')}}" class="default-color">{{ trans('teachers_trans.Home') }}</a></li>
                <li class="breadcrumb-item active">{{ trans('students_trans.edit_fee') }}</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            ...
            <div class="card-body">
                ...
                <form action="{{route('fees.updating' , $fee -> id)}}" method="POST">
                    @csrf
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col">
                            ...
                            <input type="text" name="title_ar" class="form-control" class="@error('title_ar') is-invalid @enderror"  value="{{ $fee -> getTranslation('name' , 'ar') }}">
                            @error('title_ar')
                        ...
                        <div class="form-group col">
                            ...
                            <input type="text"  class="form-control" class="@error('title_en') is-invalid @enderror" name="title_en"  value="{{ $fee -> getTranslation('name' , 'en') }}">
                            @error('title_en')
                                <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col">
                            ...
                            <input type="number"  class="form-control" class="@error('amount') is-invalid @enderror" name="amount"  value="{{ $fee -> anmount }}">
                            @error('amount')
                                <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col">
                            ...
                            <select class="custom-select mr-sm-2" name="Grade_id" class="@error('Grade_id') is-invalid @enderror">
                                <option selected value="{{ $fee -> grade_id }}">{{ $fee -> grades -> name }}</option>
                        ...
                        <div class="form-group col">
                            ...
                            <select class="custom-select mr-sm-2" name="Classroom_id" class="@error('Classroom_id') is-invalid @enderror">
                                <option selected value="{{ $fee -> classroom_id }}">{{ $fee -> classrooms -> class_name }}</option>
                        ...
                        <div class="form-group col">
                            ...
                            <select class="custom-select mr-sm-2" name="year" class="@error('year') is-invalid @enderror">
                                <option selected value="{{ $fee -> year_academic }}">{{ $fee -> year_academic }}</option>
                                @php
                                    $current_year = date("Y")
                                @endphp
                    ...
                    <a href="{{route('fees.index')}}" class="btn btn-outline-warning mb-5 float-right mt-2"> {{ trans('teachers_trans.Back') }} </a>
                </form>
