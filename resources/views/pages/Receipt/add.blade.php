...
@section('title')
    {{ trans('students_trans.add_receipt') }} {{ trans('students_trans.for') }} {{ $student -> name }} 
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0"> {{ trans('students_trans.add_receipt') }} {{ trans('students_trans.for') }} {{ $student -> name }} </h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                    <li class="breadcrumb-item"><a href="#" class="default-color">{{trans('grade_trans.Home')}}</a></li>
                    <li class="breadcrumb-item active"> {{ trans('students_trans.add_receipt') }} {{ trans('students_trans.for') }} {{ $student -> name }} </li>
                </ol>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input style="border-radius: 20px" class="form-control" name="debit" type="number" class="@error('debit') is-invalid @enderror">
