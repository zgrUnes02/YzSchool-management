...
<!-- Modal -->
<div class="modal fade" id="Delete_pay{{$pay -> id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form action="{{route('pay.destroy' , $pay -> id)}}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{trans('students_trans.question_delete_exchange')}} {{trans('students_trans.question_mark')}}
                </div>
