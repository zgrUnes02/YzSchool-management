...
@section('page-header')
    <!-- breadcrumb -->
        <div class="page-title">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="mb-0"> {{ trans('library.edit_book') }} {{ $book -> title }} </h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                        <li class="breadcrumb-item"><a href="{{route('home')}}" class="default-color">{{ trans('teachers_trans.Home') }}</a></li>
                        <li class="breadcrumb-item active"> {{ trans('library.edit_book') }} {{ $book -> title }} </li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="row mt-3">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" name="Grade_id" class="@error('Grade_id') is-invalid @enderror" value="{{ old('Grade_id') }}">
                                            <option selected value="{{ $book -> grade_id }}"> {{ $book -> grades -> name }} </option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" name="Classroom_id" class="@error('Classroom_id') is-invalid @enderror" value="{{ old('Classroom_id') }}">
                                            <option selected value="{{ $book -> classroom_id }}"> {{ $book -> classrooms -> class_name }} </option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" name="section_id" class="@error('section_id') is-invalid @enderror" value="{{ old('section_id') }}">
                                            <option selected value="{{ $book -> section_id }}"> {{ $book -> sections -> name_section }} </option>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="book_name" value="{{ $book -> title }}" class="form-control" autocomplete="none" class="@error('book_name') is-invalid @enderror">
                                    @error('book_name')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col">
                                    ...
                                    <input type="file" name="book_file_new" class="form-control" autocomplete="none" class="@error('book_file') is-invalid @enderror">
                                    @error('book_file')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <input type="hidden" value="{{ $book -> file_name }}" name="old_book">

                        <button class="mt-5 btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('library.edit_button')}}</button>
                    </form>
