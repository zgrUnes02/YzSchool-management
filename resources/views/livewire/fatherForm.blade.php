            ...
            <div class="col-md-12">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputCity">{{trans('parent_trans.father_nationality')}}</label>
                    ...
                    <div class="form-group col">
                        <label for="inputState">{{trans('parent_trans.father_type_blood')}}</label>
                    ...
                    <div class="form-group col">
                        <label for="inputZip">{{trans('parent_trans.father_relegion')}}</label>
